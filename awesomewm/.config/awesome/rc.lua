...
beautiful.init(
	string.format(
		gears.filesystem.get_configuration_dir() .. "/themes/%s/%s.lua",
...
globalkeys = my_table.join(
	...
	end, { description = "terminal with fish shell", group = "super" }),
	awful.key({ modkey, "Shift" }, "Return", function()
		awful.spawn(browser)
	end, { description = "launch firefox browser", group = "super" }),
...
if settings.focusOnHover == true then
...
if settings.useNitrogen == true then
	awful.spawn.with_shell("nitrogen --restore")
end

if settings.usePicom == true then
	awful.spawn.with_shell("picom -b")
end

if settings.useNMApplet == true then
...
if settings.useLxPolkit == true then
	awful.spawn.with_shell("/usr/bin/lxpolkit")
end

if settings.useFlameShot == true then
